...
#cgo CPPFLAGS: -I${SRCDIR}/pkg/linux_amd64__gcc48/include
#cgo LDFLAGS: -L${SRCDIR}/pkg/linux_amd64__gcc48/lib -lvirgil_crypto_go -lvirgil_crypto -lmbedcrypto -led25519 -lstdc++
